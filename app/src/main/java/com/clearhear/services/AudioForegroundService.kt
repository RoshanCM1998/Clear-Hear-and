...
import com.clearhear.audio.AudioProcessor
...
class AudioForegroundService : Service() {
    companion object {
        const val ACTION_START = "com.clearhear.action.START"
        const val ACTION_STOP = "com.clearhear.action.STOP"
        const val ACTION_SET_MODE = "com.clearhear.action.SET_MODE"
        const val ACTION_SET_PARAMS = "com.clearhear.action.SET_PARAMS"
        const val ACTION_SET_LIGHT_STRATEGY = "com.clearhear.action.SET_LIGHT_STRATEGY"
        const val ACTION_SET_POST_FILTER = "com.clearhear.action.SET_POST_FILTER"
        const val ACTION_SET_EQ_BANDS = "com.clearhear.action.SET_EQ_BANDS"
        const val ACTION_SET_EQ_MODE = "com.clearhear.action.SET_EQ_MODE"
        const val ACTION_SET_INPUT_DEVICE = "com.clearhear.action.SET_INPUT_DEVICE"
        const val ACTION_SET_OUTPUT_DEVICE = "com.clearhear.action.SET_OUTPUT_DEVICE"
        ...
        private const val NOTIF_CHANNEL_ID = "clear_hear_channel"
        private const val NOTIF_ID = 101
        private const val TAG = "ClearHear"
    }
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                NOTIF_CHANNEL_ID, "Clear Hear", NotificationManager.IMPORTANCE_LOW
            )
    ...
    private fun setupLogging() {
        ...
        logFile = File(logsDir, "clear_hear_$ts.log")
    ...
    private fun errorLog(msg: String) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            val notif = NotificationCompat.Builder(this, NOTIF_CHANNEL_ID)
                .setContentTitle("Clear Hear error")
                .setContentText(msg)
